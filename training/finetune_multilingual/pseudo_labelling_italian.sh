...
#SBATCH --mem=128G
#SBATCH --job-name=pseudo_labelling_test_italian_voxpopuli
#SBATCH --output=pseudo_labelling_test_italian_voxpopuli_logs/pseudo_labelling_test_italian_voxpopuli.out
#SBATCH --error=pseudo_labelling_test_italian_voxpopuli_logs/pseudo_labelling_test_italian_voxpopuli.err

# Create output directory
mkdir -p pseudo_labelling_test_italian_voxpopuli_logs
...
accelerate launch run_pseudo_labelling.py \
  ...
  --wandb_project "distil-whisper-labelling-italian" \
